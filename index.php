...
<body class="home">
        ...
        <header id="header" class="header-scroll top-header headrom">
            ...
            <nav class="navbar navbar-dark">
                <div class="container">
                    ...
                    <a class="navbar-brand" href="index.php"> <img class="img-rounded" src="images/swad-restora-logo.png" alt=""> </a>
                    <div class="collapse navbar-toggleable-md  float-lg-right" id="mainNavbarCollapse">
                        <ul class="nav navbar-nav">
                            <li class="nav-item"> <a class="nav-link active" href="index.php">Home <span class="sr-only">(current)</span></a> </li>
                            <li class="nav-item"> <a class="nav-link active" href="restaurants.php">Restaurant House<span class="sr-only"></span></a> </li>
        ...
        <section class="hero bg-image" data-image-src="images/img/main.jpeg">
            <div class="hero-inner">
                <div class="container text-center hero-text font-white">
                    <h1>Bangladeshi Restaurant</h1>
                    <h5 class="font-white space-xs">Bangladeshi restaurant with a menu of regional specialties</h5>
                    ...
                    <div class="steps">
                        <div class="step-item step1">
                            ...
                            <h4><span>1. </span>Choose Rest. House</h4> </div>
                        <!-- end:Step -->
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col1">
                            <div class="how-it-works-wrap">
                                <div class="step step-1">
                                    ...
                                    <h3>Choose restaurant house</h3>
                                    <p>We"ve got your covered with menus from all restaurant houses.</p>
                                </div>
                            </div>
                        </div>
        ...
        <!-- Featured restaurant houses starts -->
        <section class="featured-restaurants">
            <div class="container">
                <div class="row">
                    <div class="col-sm-4">
                        <div class="title-block pull-left">
                            <h4>Featured restaurant houses</h4> </div>
                    </div>
                    <div class="col-sm-8">
                ...
                <!-- restaurant houses listing starts -->
                <div class="row">
                ...
                <!-- restaurant houses listing ends -->
               
            </div>
        </section>
        <!-- Featured restaurant houses ends -->
            ...
            <div class="container">
                ...
                <div class="row top-footer">
                    <div class="col-xs-12 col-sm-3 footer-logo-block color-gray">
                        <a href="#"> <img src="images/swad-restora-logo.png" alt="Footer logo"> </a> <span>Order Delivery &amp; Take-Out </span> </div>
                    ...
                    <div class="col-xs-12 col-sm-2 how-it-works-links color-gray">
                        ...
                        <ul>
                            ...
                            <li><a href="#">Choose restaurant house</a> </li>
                ...
                <div class="bottom-footer">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-4 address color-gray">
                            <h5>Address</h5>
                            <p>30/5, Block-F, Babar Road, Mohammadpur, Dhaka-1207</p>
                            <h5>Phone: <a href="tel:+88029134304">+88029134304</a></h5> </div>
                        <div class="col-xs-12 col-sm-5 additional-info color-gray">
                            <h5>Addition informations</h5>
                            <p>We maintain our services ensuring the best quality</p>
                        </div>
                    </div>
                </div>
                <!-- bottom footer ends -->
